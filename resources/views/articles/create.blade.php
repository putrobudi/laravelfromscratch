            ...
            <form action="/articles" method="POST">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        ...
                        @if ($errors->has('title')) {{-- You can use @error @enderror block --}}
                ...
                <div class="field">
                    ...
                    <div class="select is-multiple control">
                        <select name="tags[]" {{-- tags[] because we have belongsToMany relationship and we want to apply multiple tags.--}}
                          multiple
                        >
                          @foreach ($tags as $tag)
                        ...
                        @error('tags')
                            ...
                            <p class="help is-danger">{{ $message }}</p> {{-- this will render error message for whatever key is passed on @error --}}
                        @enderror
                    </div>
                </div>
