...
<body class="bg-gray-180 flex items-center justify-center h-full">
    <form method="POST" action="/contact" style="width: 300px" class="bg-white p-6 rounded shadow-md">
        @csrf
        ...
        <div class="mb-5">
            ...
            @error('email') {{-- Now we have 2 levels validation. --}}
